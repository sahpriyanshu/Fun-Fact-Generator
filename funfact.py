...
def get_fun_fact(_):
    ...
    put_html("<p align='left'><h2><img src='https://drive.google.com/file/d/1DuJzcyanQzMCDxKxxZej_HfatbJuvJNX/view?usp=drive_link' width='7%'>"
    ...
    # Load the request in a json file
...
if __name__ == '__main__':
    ...
    put_html("<p align='left'><h2><img src='https://drive.google.com/file/d/1cLyQZJISa_Z4txoTqUDCbPm151Pc74zN/view?usp=drive_link' width='7%' alt='Priyanshu>"
         " Fun Fact Generator</h2></p>")
